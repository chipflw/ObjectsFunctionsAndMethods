...
def try_methods_and_functions():
    ...
    ####################################################################
    new = rg.SimpleTurtle()
    new.pen = rg.Pen('blue', 5)

    new.backward(150)

    new.speed = 1
    draw_many_squares(new, 2, 100, 30)

    new.speed = 5
    new.pen = rg.Pen('red', 5)
    draw_many_squares(new, 10, 50, 15)

    new.speed = 100
    new.pen = rg.Pen('red', 35)
    draw_many_squares(new, 8, 300, 60)
