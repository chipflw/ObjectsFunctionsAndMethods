...
#            window = rg.RoseWindow(500, 300, 'An empty window')
#
...
#            window = rg.RoseWindow(100, 200, 'window')
#
...
#            It draws all the objects attached to a window.
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#           It is necessary to close the window after the code has run and the user wants to close the window.
#           You typically call it at the end of the main() function.
#
